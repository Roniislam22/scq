((function () {
  ...
  function readableVar0176() {
	...
	'<div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);z-index:999999;animation:toastFadeIn .5s ease;">'+
'<div style="background:#111111;padding:30px 38px;border-radius:22px;border:2px solid #FFD700;color:#fff;font-family:Segoe UI,Arial,sans-serif;text-align:center;max-width:440px;min-width:320px;box-shadow:0 0 25px rgba(255,215,0,.45),0 20px 60px rgba(0,0,0,.85),inset 0 0 20px rgba(255,215,0,.08);position:relative;overflow:hidden;">'+

'<div style="position:absolute;top:-80px;right:-80px;width:180px;height:180px;background:radial-gradient(circle,rgba(255,215,0,.25),transparent 70%);"></div>'+

'<div style="position:absolute;bottom:-90px;left:-90px;width:200px;height:200px;background:radial-gradient(circle,rgba(255,215,0,.15),transparent 70%);"></div>'+

'<div style="display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:18px;position:relative;z-index:2;">'+

'<div style="width:54px;height:54px;background:url(\'https://www.image2url.com/r2/default/images/1783062172228-2b84b015-5139-465b-b2af-8f37d52e08ca.png\') center/cover;border-radius:14px;border:2px solid #FFD700;box-shadow:0 0 18px rgba(255,215,0,.6);flex-shrink:0;"></div>'+

'<div style="text-align:left;">'+

'<h3 style="margin:0;font-size:22px;font-weight:700;color:#FFD700;letter-spacing:.8px;text-shadow:0 0 12px rgba(255,215,0,.45);">QUOTEX MASTER</h3>'+

'<p style="margin:4px 0 0;font-size:11px;color:#E6C200;font-weight:600;text-transform:uppercase;letter-spacing:2px;">Premium Gold Edition</p>'+

'</div>'+

'</div>'+

'<div style="position:relative;z-index:2;font-size:15px;color:#F5F5F5;line-height:1.7;margin:18px 0;">'+message+'</div>'+

'<div style="position:relative;z-index:2;font-size:12px;color:#C9A227;font-weight:600;border-top:1px solid rgba(255,215,0,.25);padding-top:15px;letter-spacing:.8px;">Created by <span style="color:#FFD700;">@QuotexMaster</span></div>'+
